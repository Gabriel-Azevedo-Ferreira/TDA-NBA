...
V(g)$size <- listintolengths(map$points_in_vertex, nodeScale = 2)
V(g)$label.cex = .15
...
pdf("Seas2015-3030-50-20-colorbyPoints.pdf")
plot(g, layout = layout.auto(g))
dev.off()

V(g)$color <- cRamp(mostFreqcolor(map,labels = label)$mostFreq)
pdf("Seas2015-3030-50-20-colorbyPosic.pdf")
plot(g, layout = layout.auto(g))
dev.off()
